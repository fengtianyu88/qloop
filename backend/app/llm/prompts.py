...
# ---------------------------------------------------------------------------
CODE_REVIEW_PROMPT = """\
你是一位资深的 BMS SOX 算法软件代码评审专家。请对以下提交的代码包进行严格的代码评审。
...
你是一位资深的 BMS SOX 算法软件测试评审专家。请对以下提交的测试报告进行严格评审。
...
你是一位资深的 BMS SOX 算法软件专家评审委员会成员。请对以下提交的专家评审报告进行 meta 评审（即对专家评审工作的质量进行评审）。
